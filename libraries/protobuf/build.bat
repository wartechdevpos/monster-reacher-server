...
protoc tagger/tagger.proto --js_out=import_style=commonjs,binary:../../../monster-reacher-web/src/protoc --grpc-web_out=import_style=typescript,mode=grpcweb:../../../monster-reacher-web/src/protoc