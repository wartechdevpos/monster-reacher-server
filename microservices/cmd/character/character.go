...
import (
	...
	"wartech-studio.com/monster-reacher/microservices/cmd/character/manager"
)

var SERVICES_NAME = config.GetNameConfig().MicroServiceName.Character
...
func main() {
	...
	character.RegisterCharacterServer(server, manager.NewServerService())
